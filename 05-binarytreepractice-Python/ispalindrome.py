# isPalindromicPrime() Write a function isPalindromicPrime that takes a value n as a parameter and returns True 
# if the given n is a palindrome and prime and False otherwise.
